# Coronavirus (COVID-19) in the UK - API v.1
![GitHub commit activity](https://img.shields.io/github/commit-activity/y/publichealthengland/coronavirus-dashboard-api-v1)

Main API service for the data, lookup tables, CMS, and metadata
...
also the [outstanding issues](https://github.com/PublicHealthEngland/coronavirus-dashboard-api-v1/issues) from 
